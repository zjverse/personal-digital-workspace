...
- SQLite 本地存储，只保留 `categories`、`websites`、`favorites` 三张核心表
- Docker、PM2、Nginx 部署配置

## 页面预览

仓库提供了一个不含个人隐私数据的静态预览页：

[simple.html](simple.html)

它展示了当前最终页面形态：左侧深色目录、右侧浅色紧凑卡片、常用网址、星标、多选打开和常用排序按钮。
...
旧版里的用户、登录、后台、快照、操作历史、导入历史、标签关系等表和接口都不再保留。
